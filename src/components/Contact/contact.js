...
const Contact = () => {
  ...
  return (
    <section id='contactPage'>
      <div id='clients'>
        <h1 className='contactPageTittle'>My Dream Campanies</h1>
        <p className='clientDesc'>
          I want to work with a diverse group of companies. Some of the notable 
          companies I have that i want to work  with is
        </p>
